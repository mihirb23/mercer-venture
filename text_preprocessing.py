...
class TextPreprocessor:
    ...
    OOV words, and segmenting the document.
    """
    ...
    def _clean_text(self, text: str) -> str:
        ...
        # This was seen in your second PDF example.
    ...
    def _handle_oov(self, doc: spacy.tokens.Doc) -> Tuple[List[str], Dict[str, str]]:
        ...
        # Combine spaCy's vocab with our custom domain words
        ...
        for token in doc:
            if token.is_alpha and token.text.lower() not in known_words:
                ...
                # Find the closest word in our custom vocab (simple suggestion)
                closest_word = min(
                    self.custom_vocabulary, 
    ...
    def _segment_document(self, doc: spacy.tokens.Doc) -> List[Dict]:
        ...
        """
        sections = []
        # Patterns to identify section headers from your documents
        section_patterns = {
